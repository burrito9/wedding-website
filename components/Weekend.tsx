        ...
        <section className="flex flex-col items-center space-y-6">
            ...
            <div className="w-full max-w-2xl bg-white/60 p-6 sm:p-8 rounded-lg shadow-md text-center space-y-8">
                 <div className="font-montserrat text-gray-800 space-y-2">
                    ...
                    <h3 className="font-gaegu text-3xl text-brand-orange">Welcome Drinks</h3>
                    <p className="text-lg">A Quinta (short walk from the Octant)</p>
                    <p className="text-gray-600">8:00–10:30pm</p>
                    <p className="text-sm italic">Light snacks provided</p>
                 </div>
